...
cleaned_search_reasons_data = 
  cleaned_arrests_strip_data |>
  select(event_id, race, gender, reason_injury,	reason_escape, reason_weapons, reason_possess_evidence, items_found) |>
